				...
				<div class="article">
				  <h2><span>mahasiswa</span></h2>
					...
					{ 
						...
						$numresult=@mysql_query("select * from mahasiswa where MHSPA='$isidosen[DosenId]' order by MHSID desc");
						...
						else 
						{
							...
							echo "<p>Ditemukanerdapat $numrow  mahasiswa Bimbingan Anda</p>";
							// ambil hasil
							$n= "0";
							$i="1";
							...
							$result=@mysql_query("select * from mahasiswa where MHSPA='$isidosen[DosenId]' order by MHSID ASC  limit $offset,$limit");
							...
							echo "<tr bgcolor=#dedede><td colspan=11></td></tr>";
