...
if($_SESSION[sebagai]=="admin" || $_SESSION[sebagai]=="staff")
{
	...
	{ 
		// file ini digunakan untuk memproses username Mahasiswa 
		...
		if($_POST[aksi]=='simpan') 
		{
			...
			if(!empty($_POST[password]) || !empty($_POST[email]))
			{
				...
				echo "<META HTTP-EQUIV=Refresh CONTENT=\"0.1; URL=index.php?p=module/mhs_password_proses_view&uname=$_POST[MHSID]&nama=$_POST[MHSNAMA]&pword=$_POST[password]&email=$_POST[email]\">";
		...
		if($_POST[aksi]=='update') 
		{
			...
			{
				$update=mysql_query("update user set username='$_POST[MHSID]',  nama='$_POST[MHSNAMA]',  email='$_POST[email]' where username='$_POST[id]'");
			}
			else
			{
				$pass=md5($_POST['password']);
				$update=mysql_query("update user set username='$_POST[MHSID]',  nama='$_POST[MHSNAMA]',  password='$pass',  email='$_POST[email]' where username='$_POST[id]'");
			}
