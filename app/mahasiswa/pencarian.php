				  ...
				  <h2><span>mahasiswa</span></h2>
					...
					{ 
						...
						$kunci=$_GET['kunci'];
							...
							{
							$numresult=@mysql_query("select * from mahasiswa where jurusanId='$_GET[JurusanId]' AND MHSNAMA LIKE '%$kunci%' order by MHSID ASC");
							}
							if($_GET['pilihcari']=="MHSID" )
							{
							$numresult=@mysql_query("select * from mahasiswa where jurusanId='$_GET[JurusanId]' AND MHSID LIKE '%$kunci%' order by MHSID ASC");
							}
							if($_GET['pilihcari']=="MHSKOTA" )
							{
							$numresult=@mysql_query("select * from mahasiswa where jurusanId='$_GET[JurusanId]' AND MHSKOTA LIKE '%$kunci%' order by MHSID ASC");
							}
						...
						else 
						{
							...
							if($_GET['pilihcari']=="MHSNAMA" )
							{
							$result=@mysql_query("select * from mahasiswa where jurusanId='$_GET[JurusanId]' AND MHSNAMA LIKE '%$kunci%' order by MHSID ASC  limit $offset,$limit");
							}
							if($_GET['pilihcari']=="MHSID" )
							{
							$result=@mysql_query("select * from mahasiswa where jurusanId='$_GET[JurusanId]' AND MHSID LIKE '%$kunci%' order by MHSID ASC  limit $offset,$limit");
							}
							if($_GET['pilihcari']=="MHSKOTA" )
							{
							$result=@mysql_query("select * from mahasiswa where jurusanId='$_GET[JurusanId]' AND MHSKOTA LIKE '%$kunci%' order by MHSID ASC  limit $offset,$limit");
							}
