		...
		<div class="main">
		  ...
		  <div class="content">	   
			  <div class="mainbar">
				...
				?>
					<h3><span>KHS  ( <?php echo "SMT: $_GET[smt] TH AKD: $_GET[tahun] Jurusan $isiJurusan[JurusanNama]"; ?> ) </span></h3>
					<?php
					...
					{ 
						...
						if(mysql_num_rows($krssudah)!=0) //jika data ditemukan
						{
							...
							echo "</table>";
							echo "Berikut adalah nilai Anda :
							...
							<tr><td>
							<form name='formkirim' method='get' action='print_khs.php'>
							...
							<input type='submit' class='rounded' name='Cetak' value='CETAK KHS'>
							</form>
							</td>
							</tr></table><br>";
