				...
				<div class="article">
				  <h2><span>Mata Kuliah</span></h2>
					...
					{ 
						...
						//query ke table Mata Kuliah diurutkan Desc berdasar Mata KuliahId
						$numresult=@mysql_query("select * from matakuliah order by MKid desc");
						...
						if ($numrow==0) 
						{
							echo "<p>Halaman ini digunakan untuk mengelola data Mata Kuliah. Sampai saat ini belum terdapat  Mata Kuliah</p>";
						...
						else 
						{
							...
							echo "<p>Halaman ini digunakan untuk mengelola Mata Kuliah. Sampai saat ini terdapat $numrow  Mata Kuliah yang telah dibuat sebagai berikut :</p>";
							// ambil hasil
							$n= "0";
							$i="1";
							...
							$result=@mysql_query("select * from matakuliah order by MKid desc  limit $offset,$limit");
