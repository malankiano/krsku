	...
	<div class="main">
	  ...
	  <div class="menu_nav">
		<ul>
			...
			<li class="active"><a href="index.php?p=module/matkul_tambah"><img src="img/sisip.png" alt="Tambah Data" align="left">&nbsp; <b> Tambah</b></a></li>
			...
			<div class="article">
			  <h2><span>Mata Kuliah</span></h2>
				...
				{ 
					...
					//query ke table dosen diurutkan Desc berdasar MKNama
					$kunci=$_GET['kunci'];
						if($_GET['pilihcari']=="MKNama" )
				  		{
						$numresult=@mysql_query("select * from matakuliah where MKNama LIKE '%$kunci%' order by MKNama ASC");
						}
						if($_GET['pilihcari']=="MKid" )
				  		{
						$numresult=@mysql_query("select * from matakuliah where MKid LIKE '%$kunci%' order by MKNama ASC");
						}
					...
					{
						//jika ditemukan ada data Mata Kuliah
						//menmapilkan Mata Kuliah
						echo "<p>Ditemukan <b>$numrow</b>  Mata Kuliah</p>";
						// ambil hasil
						$n= "0";
						$i="1";
						$offset=$_GET['offset']; //digunakan untuk pendefinisian halaman Mata Kuliah
						if ($offset!=0) 
						{
						$no=0+$offset;
						}
						...
						if($_GET['pilihcari']=="MKNama" )
				  		{
						$result=@mysql_query("select * from matakuliah where MKNama LIKE '%$kunci%' order by MKNama ASC  limit $offset,$limit");
						}
						if($_GET['pilihcari']=="MKid" )
				  		{
						$result=@mysql_query("select * from matakuliah where MKid LIKE '%$kunci%' order by MKNama ASC  limit $offset,$limit");
						}

						
						echo "<table border=0 width=100%>";
						echo "<tr bgcolor=#dedede><td colspan=7></td></tr>";
						echo "<tr bgcolor=#dedede><td colspan=7></td></tr>";
						echo "<tr bgcolor=grey><th >No.</th><th>KODE</th><th>NAMA</th><TH>SEMESTER</TH><TH>SKS TEORI</TH><TH>SKS PRAKTEK</TH></tr>";
						echo "<tr bgcolor=#dedede><td colspan=7></td></tr>";
						while ($isiresult=@mysql_fetch_array($result)) 
						{
							...
							echo "<td>$isiresult[MKNama]</td>";
							echo "<td align='center'>$isiresult[MKSem]</td>";
							echo "<td align='center'>$isiresult[MKsksT]</td>";
							echo "<td align='center'>$isiresult[MKsksP]</td>";
							echo "<td>";
							echo "<a href=index.php?p=module/matkul_tambah&id=$isiresult[MKid]><img src='img/b_edit.png' alt='Edit'></a>";
							echo "<a href=index.php?p=module/matkul_proses&aksi=konfirmasi&id=$isiresult[MKid]><img src='img/b_drop.png' alt='Hapus'></a>";
							echo "</td>";
							echo "</tr>";
							echo "<tr bgcolor=#dedede><td colspan=7></td></tr>";
						}
						...
						// hitung jumlah
							...
							{ 
								...
								{
									echo " <span class='current'><b>".$i."</b></span>"; // cetak Mata Kuliah tanpa link
								}
