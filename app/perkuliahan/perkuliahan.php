...
if($_SESSION[sebagai]=="admin"  || $_SESSION[sebagai]=="staff" )
{
	...
	#suggest {
		...
		<!-- Start Dialog Box -->
		<div id="kotak-dialog">
			<h3 class="title"><?php echo "Cetak Peserta Kuliah"; ?><a href="#" class="close"><img src="../images/ui/close.png"></a></h3>
		...
		<div class="main">
		  ...
		  <div class="content">	   
			  <div class="mainbar">
				...
				?>
					<h3><span>Cetak Peserta Kuliah ( <?php echo "SMT: $_GET[smt] TH AKD: $_GET[tahun] Jurusan: $isiJurusan[JurusanNama]"; ?> ) </span></h3>
					<?php
					...
					//query ke table formkrs diurutkan Desc berdasar idformkrs
						...
						else 
						{
							...
							echo "<p>Halaman ini digunakan untuk mencetak peserta Kuliah berdasar Mata Kuliah. Sampai saat ini terdapat $numrow  mata kuliah</p>";
							// ambil hasil
							$n= "0";
							$i="1";
							...
							echo "<tr bgcolor=#dedede><td colspan=6></td></tr>";
							echo "<tr bgcolor=grey><th >No.</th><th>Kode MK</th><th>Nama Mata Kuliah</th><TH>SKS Teori</TH><TH>SKS Praktek</TH><TH>Peserta</TH></tr>";
							echo "<tr bgcolor=#dedede><td colspan=6></td></tr>";
							while ($isiresult=@mysql_fetch_array($result)) 
							{
								...
								echo "<td width=10%>";
								echo "<a class='open-dialog' href=perkuliahan_cetak.php?MKid=$isiresult[MKid]&smt=$_GET[smt]&tahun=$_GET[tahun]&JurusanId=$_GET[JurusanId]> <img src='img/print_pdf.gif' alt='Hapus'></a>";
								echo "</td>";
								echo "</tr>";
