				...
				?>
					...
					{ 
						...
						if(mysql_num_rows($krssudah)!=0) //jika data ditemukan
						{
							...
							&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type='submit'class='rounded' name='Submit' value='VALIDASI PEMBAYARAN'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
							...
							echo "<li>Klik Tombol <b>VALIDASI KRS</b> sebagai validasi KRS, dan memasukkan Mahasiswa sebagai peserta Kuliah (<font color='red'><b>Cek Kuitansi Pembayaran KRS)</b></font></li>";
							echo "<li>Klik tombol <b>BATALKAN</b> untuk membatalkan pemilihan mata kuliah (Mahasiswa akan kembali melakukan proses pemilihan Mata Kuliah)</li>";
							echo "<li>Tombol <b>VALIDASI KRS </b> dan <b>BATALKAN</b> diatas muncul karena karena Mahasiswa <b>belum menyelesaikan Administrasi</b>. Untuk validasi KRS mahasiswa harus menunjukkan kuitansi Pembayaran, jika kuitansi pembayaran dinyatakan lunas petugas bisa melakukan <b>VALIDASI KRS</b></li>";
							echo "</ol>";
							echo "</p>";
							} else {
