...
if($_SESSION[sebagai]=="admin" || $_SESSION[sebagai]=="staff")
{
	...
	?>
		...
		<body onload="document.forms[0].MHSid.focus();">
		<!-- Start Dialog Box -->
		<div id="kotak-dialog">
		...
		<div class="main">
		  ...
		  <div class="content">	   
			  <div class="mainbar">
				...
				?>
				  <h3><span>Kelola Pengambilan Mata Kuliah / KRS</span></h3>
					<?php
					...
					//formulir pemilihan semester dan tahun 
						...
						echo "
						<form name='form1' method='get' action='kelola_krs.php'>
						NIM: 
					  <input type=text class=rounded id='MHSid'size='10' name='MHSid'>
					  Semester :
	 ...
	 echo" &nbsp; &nbsp;&nbsp;<input type='submit' class=rounded name='Submit' value='Lihat !'>
	</form>";			
	echo "</b></div>";			
