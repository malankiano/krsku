		...
		<div class="main">
		  ...
		  <div class="menu_nav">
			<ul>
				...
				<li class="active"><a href="index.php?p=module/dosen_tambah"><img src="img/sisip.png" alt="Tambah Data" align="left">&nbsp; <b> Tambah</b></a></li>
				...
				<div class="article">
				  <h2><span>Dosen</span></h2>
					...
					{ 
						...
						$numresult=@mysql_query("select * from dosen order by DosenId desc");
						...
						if ($numrow==0) 
						{
							echo "<p>Halaman ini digunakan untuk mengelola data Dosen. Sampai saat ini belum terdapat  Dosen</p>";
						...
						else 
						{
							...
							//menmapilkan Dosen
							echo "<p>Halaman ini digunakan untuk mengelola Dosen. Sampai saat ini terdapat $numrow  Dosen yang telah dibuat sebagai berikut :</p>";
							// ambil hasil
							$n= "0";
							$i="1";
							$offset=$_GET['offset']; //digunakan untuk pendefinisian halaman Dosen
							if ($offset!=0) 
							{
							$no=0+$offset;
							}
							...
							$result=@mysql_query("select * from dosen order by DosenId desc  limit $offset,$limit");
